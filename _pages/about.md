...
<div style="max-height:280px; overflow-y:auto; border:1px solid #ccc; padding:10px;">
  <ul>
    ...
    <li><em>2026.06</em>: One paper was accepted by MICCAI 2026.</li>
...
**Journal Reviewer:**
IEEE Transactions on Image Processing (TIP), Transactions on Machine Learning Research (TMLR), Neural Networks (NN), ACM Computing Surveys (CSUR), Array, Information Processing and Management (IPM), Chemometrics and Intelligent Laboratory Systems (CILS)
